using MyRepository = GentleRain.RYS.Statistic.Administration.Repositories.UserRoleRepository;
using MyRow = GentleRain.RYS.Statistic.Administration.UserRoleRow;
