using MyRepository = GentleRain.RYS.Statistic.Administration.Repositories.UserPermissionRepository;
using MyRow = GentleRain.RYS.Statistic.Administration.UserPermissionRow;

namespace GentleRain.RYS.Statistic.Administration.Endpoints;
